...
<template>
  <div class="matrixTab-container"></div>
  <div class="main-container">
    <div class="container">
      ...
      <div style="width:50%;margin-left:2%;height:92vh" class="right-container">
        <div class="title" style="height:4vh">村庄发展潜能评价表</div>
        <div class="table" style="height:88vh">
...
interface tableItem {
  decisionAims: string
  criterionLayer1: string
  weight1: number
  criterionLayer2: string
  weight2: number
}
...
const objectSpanMethod = ({ row, column, rowIndex, columnIndex }: SpanMethodProps) => {
  ...
  if (columnIndex === 1 || columnIndex === 2) {
    if (rowIndex === 0 || rowIndex === 8 || rowIndex === 25 || rowIndex === 27 || rowIndex === 29 || rowIndex === 31) {
      return {
        rowspan: 2,
        colspan: 1
      }
    } else if (rowIndex === 2 || rowIndex === 5 || rowIndex === 10 || rowIndex === 19 || rowIndex === 22) {
      return {
        rowspan: 3,
        colspan: 1
      }
